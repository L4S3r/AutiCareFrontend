...
<img src="https://img.shields.io/badge/AutiCare-Web\_Dashboard-0ea5e9?style=for-the-badge\&logoColor=white" height="40"/>
...
[**Live Demo**](https://auti-care-frontend.vercel.app) · [**Backend Repo**](https://github.com/L4S3r/AutiCareBackend) · [**Mobile App**](https://github.com/L4S3r/AutiCareMobile)
...
```env
# Backend API
NEXT\_PUBLIC\_API\_URL=https://auti-care-backend.vercel.app
...
|[AutiCareMobileApp](https://github.com/L4S3r/AutiCareMobileApp) (private)|Flutter mobile app (iOS \& Android)|
